    ...
    <ul ref="uli" class="chat-thread">
      ...
      <li>
        <div>
          <p ref="wen">不舒服了是吧？</p>
          <div class="btn">
            <button name="btnYes" ref="btnYes" @click="btnYes()" class="liBtn">
              是
            </button>
            <button name="btnNo" ref="btnNo" @click="btnNo()" class="liBtn" :disabled="isViliable">
              否
            </button>
          </div>
        </div>
      </li>
      <li v-for="(one,index) in messList" :key="index" >
        <div>
          <p ref="wen" :style="index%2==0?'color:black':''">{{one}}</p>
          <div class="btn" v-if="index%2 !==0">
            <button name="btnYes" ref="btnYes" @click="btnYes()" class="liBtn">
              是
            </button>
            <button name="btnNo" ref="btnNo" @click="btnNo()" class="liBtn" v-if="isNo==1 || index!==messList.length-1">
              否
            </button>
            <button name="btnNo" ref="btnNo" @click="btnNo()" class="liBtn" v-if="isNo==2 && index==messList.length-1" style="display:none">
              否
            </button>
          </div>
        </div>
...
export default {
  ...
  methods: {
    getQuery: function () {
      const { y, i, isSex, isAge } = this.$route.query;
      const zz = this.$refs.zz;
      const wen = this.$refs.wen;
      const yes = document.getElementsByName("btnYes");
      const no = document.getElementsByName("btnNo");
      if (y != null && y != "") {
        if (y == 1) {
          if (i == 0) {
            zz.innerHTML = "头部，腮腺肿大";
            wen.innerHTML =
              "是否伴有发热，皮肤潮红、局部水肿，有压痛，按压腺体有脓液流入口腔，腺体肿大可伴有暂时性面瘫？";
          } else if (i == 1) {
            zz.innerHTML = "头部，头晕";
            wen.innerHTML =
              "是否伴有四肢无力，部分身体麻木，视觉模糊，语言困难？";
          } else if (i == 2) {
            zz.innerHTML = "头部，耳痛";
          ...
          if (i == 0) {
            ...
            wen.innerHTML =
              "发生于青春发育期、妊娠期或哺乳期，甲状腺轻度或中度肿大，表面光滑，质地柔软，甲状腺功能检查正常？";
          } else if (i == 1) {
          ...
          if (isSex == 2 && isAge == 1) {
            if (i == 0) {
              zz.innerHTML = "胸部，咳痰";
              wen.innerHTML =
                "是否反复发作、呼吸困难、喘鸣音、伴胸闷、烦躁不安？";
            } else if (i == 1) {
              zz.innerHTML = "胸部，乳房肿块";
              wen.innerHTML =
                "是否双侧乳房都有许多小包块。较小，而且容易移动？";
            } else if (i == 2) {
              zz.innerHTML = "胸部，肩部疼痛";
              wen.innerHTML =
                "疼痛是否伴有胸痛、颈部或手臂疼痛或针刺感，甚至呼吸短促、眩晕、大汗？";
            } else if (i == 3) {
              zz.innerHTML = "胸部，喘鸣";
              wen.innerHTML =
                "是否在吸进了冷空气、粉尘、烟雾、花粉等之后而发作？";
            } else if (i == 4) {
              zz.innerHTML = "胸部，乳房疼痛";
              wen.innerHTML = "是否在怀孕期间？";
            } else if (i == 5) {
              zz.innerHTML = "胸部，咳嗽";
              wen.innerHTML = "是否吸入了刺激性气体或烟雾？";
            } else if (i == 6) {
              zz.innerHTML = "胸部，心悸";
              ...
              zz.innerHTML = "胸部，胸痛";
              wen.innerHTML =
                "是否是压榨性疼痛或者感觉胸部被撕裂一样的疼痛，可放射至颈、肩或臂？";
            }
          } else {
            if (i == 0) {
              zz.innerHTML = "胸部，咳痰";
          ...
          if (i == 0) {
            zz.innerHTML = "背部，腰痛";
            wen.innerHTML =
              "是否有腰部损伤史或在搬举重物后出现腰骶部疼痛，并向下肢后侧放射，弯腰、屈髋伸膝疼痛加剧，伴有麻木感？";
          }
        } else if (y == 5) {
          if (isSex == 2 && isAge == 1) {
            if (i == 0) {
              ...
              wen.innerHTML =
                "是否有胃十二指肠胃溃疡病史，突然疼痛加剧，呕血后疼痛缓解？";
            } else if (i == 4) {
              zz.innerHTML = "腹部，痛经";
              wen.innerHTML = "您是否有月经淋漓不净或月经紊乱？";
              this.isNo=2;
            } else if (i == 5) {
          ...
          if (isAge == 1) {
            ...
            if (isSex == 1) {
              ...
              //女
              if (i == 0) {
                zz.innerHTML = "生殖器，月经过多";
                wen.innerHTML = "是否刚生完孩子？";
              } else if (i == 1) {
                zz.innerHTML = "生殖器，白带异常";
                wen.innerHTML = "是否正在服用雌性激素类药物、避孕药物？";
              } else if (i == 2) {
                zz.innerHTML = "生殖器，月经不调";
                wen.innerHTML =
                  "月经是否比平常推迟了一个星期，而且在这之前有过性交？";
              } else if (i == 3) {
                zz.innerHTML = "生殖器，闭经";
                wen.innerHTML =
                  "幼年时是否曾患肺结核或其他部位结核，第二性征正常，有时出现周期性下腹胀痛？";
              } else if (i == 4) {
                zz.innerHTML = "生殖器，阴道出血";
                wen.innerHTML = "是否有外伤史，伴有外阴血肿？";
              }
            }
          } else if (isAge == 2) {
            //小孩
          ...
          if (i == 0) {
            ...
            zz.innerHTML = "皮肤（鳞屑）";
            wen.innerHTML =
              "是否颜面，手足或全身弥漫性红肿，肿胀消退后出现脱屑，手足部呈破手套或破袜套样脱落没头发，指甲亦可见脱落？";
          } else if (i == 7) {
            zz.innerHTML = "皮肤（脓疱疹）";
            wen.innerHTML =
              "是否发生在新生儿，疱疹破溃后形成红色糜烂面，伴有发热，体温可达39°C以上？";
          } else if (i == 8) {
            zz.innerHTML = "皮肤（皮肤溃疡）";
            wen.innerHTML =
              "是否患有糖尿病，在腿部或脚部发生外伤后出现，伤口经久不愈而形成糜烂溃疡，无痛？";
          } else if (i == 9) {
            zz.innerHTML = "皮肤（皮肤肿块）";
            wen.innerHTML =
              "肿块是否呈黄豆大小，可移动，无压痛，头部及躯干较多？";
          }
        } else if (y == 11) {
          //					alert("耳鼻");
          if (i == 0) {
            ...
            zz.innerHTML = "眼（眼睛红）";
            wen.innerHTML =
              "春秋季流行，是否双眼有异物感,疼痛，畏光，流泪，有水行或粘性分泌物，结膜充血，水肿，耳前淋巴结肿大？";
          } else if (i == 5) {
            zz.innerHTML = "眼（干涩）";
            ...
            zz.innerHTML = "眼（眼痛）";
            wen.innerHTML =
              "是否伴有视力下降，眼球转动时有牵引性疼痛，压迫眼球有明显球后疼痛？";
            this.isNo=2;
          } else if (i == 10) {
            zz.innerHTML = "眼（白瞳症）";
            wen.innerHTML =
              "是否为早产儿，且体重低于1500g，出生后10-14天内接受到浓度氧治疗？";
          } else if (i == 11) {
            zz.innerHTML = "眼（嘴痛）";
            wen.innerHTML =
              "上唇部及周围是否疼痛，是否发热，并在疼痛处出现红色小包？";
          } else if (i == 12) {
            zz.innerHTML = "眼（听力下降）";
            ...
            zz.innerHTML = "眼（眼屎多）";
            wen.innerHTML =
              "是否伴有眼脸下垂，一侧面部变得的软弱无力，耳朵痛？";
          } else if (i == 15) {
            zz.innerHTML = "眼（流泪）";
            wen.innerHTML =
              "是否伴有红眼，眼分泌物多，有异物，眼内烧灼疼痛等？";
          } else if (i == 16) {
            zz.innerHTML = "眼（流鼻血）";
            wen.innerHTML =
              "有无外伤史（鼻面部外伤，用力控鼻，剧烈地打喷嚏等）？";
          }
        } else if (y == 12) {
          //					alert("其他");
          if (i == 0) {
            ...
            zz.innerHTML = "其他（高血压）";
            wen.innerHTML =
              "是否居住海拔较低地区的人进住海拔3500m以上的高原地区后出现的血压升高，且伴有食欲不振，恶心，呕吐，腹胀，烦躁不安，眩晕，健忘？";
          } else if (i == 5) {
            zz.innerHTML = "其他（周身疼痛）";
            wen.innerHTML =
              "是否以大关节游走行肿痛为主，伴有咽痛，发热，多汗，扁桃皮炎，心脏炎和慢性咽炎？";
            this.isNo=2;
          } else if (i == 6) {
            zz.innerHTML = "其他（低血压）";
            ...
            wen.innerHTML =
              "得病急骤，四肢皮肤，粘膜出现散在或密集的紫癜，瘀斑，牙龈出血？";
            this.isNo=2;
          } else if (i == 8) {
    ...
    btnNo: function () {
      ...
      no[no.length - 1].disabled = "disabled";
      const { y, i, isSex, isAge } = this.$route.query;
      this.isViliable=true;
      this.messList.push("否")
      var mess = "不舒服了是吧啊？";
      if (y == 1) {
        if (i == 0) {
          if (this.index == 1) {
            mess =
              "是否按压腺体有脓液流入口腔，腺体肿大可伴有暂时性面瘫？是否发生在中老年，在耳垂后下方，圆形或椭圆形，表面光滑，少有结节，质地软，有弹性，时大时小？";
            this.insetHl(mess);
            this.isNo=1;
          } else if (this.index == 2) {
            mess =
              "是否发生在中年以上，单侧腮腺内无痛性肿块，生长缓慢，无自觉症状，呈结节状，周界清楚，有一定的活动度？";
            this.insetHl(mess);
            this.isNo=2;
          }
        } else if (i == 1) {
        ...
        if (i == 0) {
          if (this.index == 1) {
            ...
            mess =
              "是否伴有眼球突出、心悸、胸闷、怕热、多汗、食欲亢进、消瘦、甲状腺肿大等症状和体征？";
            this.insetHl(mess);
            this.isNo=1;
          } else if (this.index == 4) {
            ...
            mess =
              "甲状腺出现硬性无痛性肿块，表面不平，生长速度较快，形态不规则，活动度差，后起出现声音、吞咽困难、呼吸困难等压迫症状？";
            this.insetHl(mess);
            this.isNo=2;
          }
        } else if (i == 1) {
          ...
          if (this.index == 1) {
            ...
            mess =
              "是否经常保持一个不舒服的姿势，不能低头或偏头，症状持续不缓解？";
            this.insetHl(mess);
            this.isNo=1;
          } else if (this.index == 3) {
            mess =
              "转动颈部时，是否听到咯吱咯吱的声音，或者觉得头部和上肢麻木、针刺感？";
            this.insetHl(mess);
            this.isNo=2;
          }
        }
        ...
        if (isSex == 2 && isAge == 1) {
          if (i == 0) {
            if (this.index == 1) {
              ...
              mess =
                "是否有长期吸烟史，伴刺激性咳嗽，血痰，胸痛或进行性加重的呼吸困难？";
              this.insetHl(mess);
              this.isNo=2;
            }
          } else if (i == 1) {
            if (this.index == 1) {
              mess = "是否在沒有哺乳的情況下一侧乳头出现分泌物？";
              this.insetHl(mess);
              this.isNo=2;
            }
          } else if (i == 2) {
            ...
            if (this.index == 1) {
              ...
              mess =
                "是否伴有胸部皮肤的灼热伤感，而且疼痛处皮肤有水疱，疼痛随呼吸运动加重？";
              this.insetHl(mess);
              this.isNo=1;
            } else if (this.index == 4) {
        ...
        if (i == 0) {
          if (this.index == 1) {
            ...
            mess =
              "疼痛是否从腰部向下放射至膀胱区，外阴部及大腿内侧，有时伴有大汗，恶心呕吐?";
            this.insetHl(mess);
            this.isNo=2;
          }
        }
        ...
        if (isSex == 2 && isAge == 1) {
          if (i == 0) {
            ...
            if (this.index == 1) {
              ...
              mess="是否脐周或中上腹疼痛，伴有恶心、呕吐，随着病情发展，疼痛转移或集中在右下腹？"
              this.insetHl(mess);
              this.isNo=1;
            }
            else if (this.index == 3) {
            ...
            if (this.index == 1) {
              mess =
                "近来是否服用激素，阿司匹林抗炎药物等，突发呕血，大便呈柏油样？";
              this.insetHl(mess);
            } else if (this.index == 2) {
              mess =
                "是否有较严重的肝病史，突然发生呕血，颜色鲜红，并伴有黑便？";
              this.insetHl(mess);
            } else if (this.index == 3) {
            ...
            if (this.index == 1) {
              ...
              mess =
                "是否有吃一点就饱，上腹部有饱胀感，恶心，厌食，甚至出现体重减轻等症状？";
              this.insetHl(mess);
            } else if (this.index == 3) {
          ...
          if (isSex == 1) {
            ...
            if (i == 0) {
              if (this.index == 1) {
                ...
                mess =
                  "是否伴有尿频，尿排不尽感。尿道不适。灼热，或精液中可含又少量血液（血精）？";
                this.insetHl(mess);
                this.isNo=1;
              } else if (this.index == 4) {
                mess = "是否包皮过长或者包茎？";
            ...
            if (i == 0) {
              if (this.index == 1) {
                mess = "是否伴有发热和阴道分泌物异常增多？";
                this.insetHl(mess);
                this.isNo=1;
              } else if (this.index == 2) {
                mess = "月经是否推迟一周以上，而且在这之前有过性生活？";
                this.insetHl(mess);
                this.isNo=1;
              } else if (this.index == 3) {
                mess = "是否只有一次或两次月经没来？";
              ...
              if (this.index == 1) {
                mess =
                  "白带增多并伴外阴瘙痒，白带呈灰黄色、泡沫状稀薄液体，或呈脓性，有腥臭，甚至混有血液？";
                this.insetHl(mess);
                this.isNo=1;
              } else if (this.index == 2) {
                mess =
                  "白带是否增多，且呈乳白色粘液状，有时为淡黄色、脓性或血性？";
                this.insetHl(mess);
                this.isNo=1;
              } else if (this.index == 3) {
                mess = "是否在放置宫内节育器后出现白带中带血？";
                this.insetHl(mess);
                this.isNo=2;
              }
            } else if (i == 2) {
              if (this.index == 1) {
                mess =
                  "最近是否有下列情况：饮食改变；健康状况改变；生活方式和工作改变；精神压力大？";
                this.insetHl(mess);
                this.isNo=1;
              } else if (this.index == 2) {
                mess = "是否从来没有来过月经？";
        ...
        if (i == 0) {
          ...
          if (this.index == 1) {
            mess = "指甲变形、色变到灰褐色、暗黄色、趾甲变厚而难剪，但甲面变得很薄、很脆；有怪味，会痛？";
            this.insetHl(mess);
            this.isNo=2;
          }
        }
        ...
        if (i == 0) {
          ...
          if (this.index == 1) {
            ...
            mess =
              "是否更换了化妆品，衣服，收拾，服用某些药物，或接触了刺激性皮肤物质等？";
            this.insetHl(mess);
            this.isNo=2;
          }
        } else if (i == 2) {
          if (this.index == 1) {
            ...
            mess =
              "是否伴有甲状腺功能减退，甲状腺功能亢进，垂体前叶功能减退症等？";
            this.insetHl(mess);
            this.isNo=2;
          }
        } else if (i == 3) {
          ...
          if (this.index == 1) {
            mess =
              "局部表皮损伤后是否露出红色湿润面，肠胃水泡破裂或皮肤浸渍后表皮脱落所致，愈合后一般不留瘢迹？";
            this.insetHl(mess);
            this.isNo=1;
          } else if (this.index == 2) {
            mess =
              "是否在皮肤损伤或手术上后愈合后出现局部皮肤隆起，色红质硬的肿块？";
            this.insetHl(mess);
            this.isNo=1;
          } else if (this.index == 3) {
            mess =
              "皮肤表面是否有裂痕，常见于足后跟手指，手掌，口角，肛周等处，伴疼痛或出血？";
            this.insetHl(mess);
            this.isNo=2;
          }
        } else if (i == 5) {
          ...
          if (this.index == 1) {
            mess =
              "是否好发于面部，初起为淡红色，表面干燥，附有灰白色糖状鳞屑，对称分布，数月可自行消退，但可复发？";
            this.insetHl(mess);
            this.isNo=1;
          } else if (this.index == 2) {
            mess = "是否好发于躯干和四肢近端的玫瑰色斑块，其上有糖状鳞屑？";
            this.insetHl(mess);
            this.isNo=1;
          } else if (this.index == 3) {
            mess =
              "是否出现大小不等的丘疹，表面覆盖着银白色鳞屑，多发于头皮，四肢及背部？";
            this.insetHl(mess);
            this.isNo=2;
          }
        } else if (i == 7) {
          if (this.index == 1) {
            mess =
              "是否好发于下肢，脓疱破溃后形成溃疡，自觉疼痛，发热，附近淋巴结肿大，愈后留有瘢迹？";
            this.insetHl(mess);
            this.isNo=2;
          }
        } else if (i == 8) {
        ...
        //耳鼻眼
          ...
          if (this.index == 1) {
            ...
            mess =
              "鼻塞为间接性，白天天热或运动后减轻，夜间，寒冷或入座后加重，侧卧时下侧鼻塞较重？";
            this.insetHl(mess);
            this.isNo=2;
          }
        } else if (i == 5) {
          if (this.index == 1) {
            mess =
              "眼脸内侧或外侧是否出现异状胬肉（比如鸟翼），表面平行，尖端向中间攀移，血管充血？";
            this.insetHl(mess);
            this.isNo=1;
          } else if (this.index == 2) {
            mess =
              "是否伴眼痛，畏光流泪，视力减退，瞳孔缩小，对光反射迟钝等症状？";
            this.insetHl(mess);
            this.isNo=2;
          }
        } else if (i == 6) {
          if (this.index == 1) {
            ...
            mess =
              "是否处于更年期，且伴有眼干，口烂，萎缩性舌炎，口腔黏膜糜烂，灼痛及刺激痛等？";
            this.insetHl(mess);
            this.isNo=2;
          }
        } else if (i == 7) {
          ...
          if (this.index == 1) {
            mess =
              "是否出现单侧眼脸红肿，下垂，并伴有疼痛，复视及眼球运动障碍？";
            this.insetHl(mess);
            this.isNo=1;
          } else if (this.index == 2) {
            mess =
              "是否伴有高热，眼睛和结膜高度充血，水肿，眼脸部皮肤红肿，压痛？";
            this.insetHl(mess);
            this.isNo=2;
          }
        } else if (i == 10) {
           if (this.index == 1) {
             mess = "最近是否压力大、焦虑、情绪激动？";
             this.insetHl(mess);
             this.isNo=1;
          }else if(this.index==2){
            mess = "是否感染、创伤、手术？";
          ...
          if (this.index == 1) {
            ...
            mess =
              "是的在遇到光线时瞳孔区出现黄色或白色反光，视力丧失，或出现斜视，瞳孔发白？";
            this.insetHl(mess);
            this.isNo=1;
          } else if (this.index == 3) {
          ...
          if (this.index == 1) {
            ...
            mess = "眩晕突然出现而且很严重，且伴有恶心，呕吐？";
            this.insetHl(mess);
            this.isNo=1;
          } else if (this.index == 3) {
            mess =
              "是否感到眩晕，失去平衡，伴有麻木，四肢移动困难，语言困难，视力模糊，意识模糊？";
            this.insetHl(mess);
            this.isNo=2;
          }
        } else if (i == 15) {
        ...
        if (i == 0) {
          ...
          if (this.index == 1) {
            ...
            mess =
              "是否已经怀孕，在妊娠20周后至产后24小时内出现高血压，或蛋白尿？";
            this.insetHl(mess);
            this.isNo=2;
          }
        } else if (i == 3) {
          ...
          if (this.index == 1) {
            mess =
              "是否发生在从平卧位转变为直立位，或长时间站立时，体质瘦弱的女性，可伴有头晕或晕厥，无器质性疾病或者营养不良？";
            this.insetHl(mess);
            this.isNo=1;
          } else if (this.index == 2) {
            mess =
              "是否晨起出现低血压，站立式头晕眼花，腿软乏力，一过性黑瞳，晕眩或昏厥？";
            this.insetHl(mess);
            this.isNo=2;
          }
        } else if (i == 7) {
